...
export default function CaseStudiesSection() {
  ...
  useEffect(() => {
    ...
    caseStudyCards.forEach((card, index) => {
      card.classList.add(`animate-delay-${index * 300}`);
  ...
  return (
    <section id="case-studies" ref={sectionRef} className="section-padding section-transition bg-background/50">
      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="grid grid-cols-1 gap-16 mt-16">
          {caseStudies.map((study, index) => (
            <Card key={index} className="case-study-card section-transition opacity-0 overflow-hidden border-none shadow-glow bg-transparent">
